...
router.get("/ads/favorite", authenticate, ctrlWrapper(ctrl.getMyFavoriteAdsCategory));
...
router.patch("/:noticeId/favorite-add", authenticate, ctrlWrapper(ctrl.addToFavorite));

// видалення оголошення авторизованого користувача доданих цим же до обраних
router.patch("/:noticeId/favorite-remove", authenticate, ctrlWrapper(ctrl.removeFromFavorite));
